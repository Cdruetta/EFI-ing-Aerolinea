...
SECRET_KEY = 'django-insecure-v-yw)lqorg%uy@5t7bg10il!wf63wf#y-$(&jxm8wfvqu5d&z!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'gestionVuelos', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Carpeta donde van a estar los archivos de traducción (.po/.mo)
LOCALE_PATHS = [
