...
urlpatterns = [
    ...
    path(
        "passengers/<int:pk>/", PassengerDetailView.as_view(), name="passenger_detail"
    ),
    path(
        "passengers/<int:pk>/edit/",
        PassengerUpdateView.as_view(),
        name="passenger_edit",
    ),
    path(
        "passengers/<int:pk>/delete/",
        PassengerDeleteView.as_view(),
